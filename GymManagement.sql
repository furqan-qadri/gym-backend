...
--
-- Host: localhost
-- Generation Time: May 27, 2024 at 10:02 AM
...
(1, '2024-05-20', 'New Gym Equipment Arrived', 'We are excited to announce that our gym has received new state-of-the-art equipment to enhance your workout experience. The new equipment includes top-of-the-line treadmills, elliptical machines, weightlifting benches, and more. We believe that these additions will make your workouts more enjoyable and effective. Come and try them out today!'),
(2, '2024-05-22', 'Group Fitness Classes Schedule Update', 'Please note that our group fitness classes schedule has been updated. We have added new classes such as Zumba, Pilates, and Kickboxing to our schedule. Additionally, some existing classes have been rescheduled to better accommodate our members. Check our website or contact us for the latest schedule and class offerings. We look forward to seeing you in our classes!'),
(3, '2024-05-25', 'Special Promotion: Refer a Friend', 'Refer a friend to our gym and get one month free membership! Spread the word and enjoy the benefits together. This promotion is our way of thanking our loyal members for their support and for helping us grow our gym community. There is no limit to the number of friends you can refer, so start referring today and enjoy even more savings on your membership. Don\'t miss out on this opportunity!');
...
(7, 'Alice Smith', 30, 'Female', '0987654321', 1, '987-654-3210', 'alice@example.com', '456 Elm St, Town', '2024-05-03', 2, 2, '1994-03-15'),
(8, 'Bob Johnson', 35, 'Male', '5678901234', 1, '567-890-1234', 'bob@example.com', '789 Oak St, Village', '2024-05-05', 3, 3, '1989-07-20'),
(9, 'Emily Brown', 28, 'Female', '4321098765', 1, '432-109-8765', 'emily@example.com', '321 Pine St, Countryside', '2024-05-07', 1, 4, '1996-11-10'),
...
(13, 'Fatimah binti Ismail', 35, 'Female', '8901234567', 1, '013-4567890', 'fatimah@example.com', '456 Jalan Tun Razak, Johor Bahru', '2024-05-13', 2, 2, '1989-09-20'),
...
INSERT INTO `Trainers` (`trainer_id`, `full_name`, `age`, `sex`, `IC_Passport`, `active_status`, `phone`, `email_id`, `address`, `sign_up_date`, `experience`) VALUES
(1, 'Trainer 1', 30, 'Male', '1234567890', 1, '123-456-7890', 'trainer1@example.com', '123 Gym St, City', '2024-04-01', 5),
(2, 'Trainer 2', 35, 'Female', '0987654321', 1, '987-654-3210', 'trainer2@example.com', '456 Fitness Blvd, Town', '2024-04-02', 8),
(3, 'Trainer 3', 28, 'Male', '5678901234', 1, '567-890-1234', 'trainer3@example.com', '789 Workout Ave, Village', '2024-04-03', 3),
(4, 'Trainer 4', 40, 'Female', '4321098765', 1, '432-109-8765', 'trainer4@example.com', '321 Exercise Rd, Countryside', '2024-04-04', 10),
(5, 'Trainer 5', 25, 'Male', '9876543210', 1, '987-654-3210', 'trainer5@example.com', '654 Health Lane, Suburb', '2024-04-05', 2);
